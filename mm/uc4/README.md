...
#### Forecast
In terms how the graph looks like, this use case is similar to the previous use case.  There is a sudden increase in the metrics value.  Metric Manager can perform non-linear forecasting based on the previous value of the metrics.
